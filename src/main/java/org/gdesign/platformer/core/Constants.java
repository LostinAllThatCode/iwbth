...
public class Constants {
	...
	public static final int CATEGORY_PLAYER_PROJECTILE	= 0x0200;
	public static final int CATEGORY_ENEMY_PROJECTILE	= 0x0400;
	...
	public static final int MASK_PLAYER 				= CATEGORY_WORLD | CATEGORY_UPGRADE | CATEGORY_ENEMY | CATEGORY_OBJECT | CATEGORY_ENEMY_PROJECTILE;	
	public static final int MASK_UPGRADE 				= CATEGORY_PLAYER;
	public static final int MASK_ENEMY 					= CATEGORY_WORLD | CATEGORY_PLAYER | CATEGORY_PLAYER_PROJECTILE | CATEGORY_ENEMY;
