...
public class Enemy extends Entity {
	...
	public Enemy(World world, int x, int y, String behaviour, Texture texture) {
		super(world);
		this.addComponent(new Position(x,y));
		this.addComponent(new Behaviour(this,behaviour));
		this.addComponent(new Physics(world,x,y,12,52,BodyType.DynamicBody,Constants.CATEGORY_ENEMY, Constants.MASK_ENEMY,this));
		this.addComponent(new Renderable(texture));
		this.addToWorld();
	}
	
	public Enemy(World world, int x, int y, String behaviour, Texture texture, String json) {
		super(world);
		this.addComponent(new Position(x,y));
		this.addComponent(new Behaviour(this,behaviour));
		this.addComponent(new Physics(world,x,y,12,52,BodyType.DynamicBody,Constants.CATEGORY_ENEMY, Constants.MASK_ENEMY,this));
		this.addComponent(new Animatable(texture,json));
		this.addToWorld();
	}
